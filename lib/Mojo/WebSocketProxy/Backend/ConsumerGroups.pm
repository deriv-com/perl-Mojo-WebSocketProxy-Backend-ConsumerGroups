...
sub call_rpc {
    ...
    if ($rpc_timeout_extend_offset || $rpc_timeout_extend_percentage) {
        ...
        $log->debug("ConsumerGroups::call_rpc category_timeout = $category_timeout");
        $log->debug("ConsumerGroups::call_rpc category_deadline = $category_deadline");
    }
